ChargebeeRails.configure do |config|
  ...
  config.default_plan_id = '<default-plan>'
  ...
  config.chargebee_site = '<your-chargebee-site-name>'
  config.chargebee_api_key = '<your-chargebee-api-key>'
...
Braintree::Configuration.merchant_id = "xxxx"
Braintree::Configuration.public_key = "xxxxx"  
